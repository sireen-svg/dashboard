          ...
          <div className="d-flex align-items-center gap-0">
            ...
            <div className="project-selector" ref={dropdownRef}>
              ...
              >
                ...
                <i
                  className={`bi bi-chevron-down project-selector-chevron ${open ? "open" : ""}`}
                ></i>
              </button>
                  ...
                  <div className="project-selector-list">
                    ...
                    {projects.map((p) => {
                      ...
                      return (
                        ...
                        >
                          <span className="project-selector-item-name">
                            {p.name}
                          </span>
                          <span className="project-selector-item-id">
                            {(p.public_id || String(p.id)).substring(0, 8)}
                          </span>
